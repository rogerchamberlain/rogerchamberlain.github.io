...
[Two's complement](https://en.wikipedia.org/wiki/Two%27s_complement) is used here to store `signed` numbers. If you still have confusions about `signed` and `unsigned` numbers, please read [Introduction to Information Representation](/~cse132/guides/intro-to-information.html) guide for detailed explanations.
