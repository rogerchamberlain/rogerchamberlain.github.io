...
<aside class="warning">
The temperature sensor *will burn you* if you wire it incorrectly. *Double check your connections before powering the Arduino.*
</aside>
...
<a name="equation">
$$ T_C = 25^{\circ} C + (V_{measured} - .25V) \cdot 100 \frac{^{\circ} C}{V} $$
</a>
